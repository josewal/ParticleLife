...
public class Particle implements ISpatial {
	...
	public void drawForceMaxRadius(Graphics2D g2, Camera c) {
	...
	public void drawForceMinRadius(Graphics2D g2, Camera c) {

		int radius = (int) c.zoomElongation(force.avgMinRadius);
		int screenX = c.getFrameX(pos.x) - radius;
		int screenY = c.getFrameY(pos.y) - radius;

		g2.setColor(new Color(255, 0, 255, 2));
		g2.fillOval(screenX, screenY, 2 * radius, 2 * radius);
	}
